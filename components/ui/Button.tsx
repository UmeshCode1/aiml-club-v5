...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const variants = {
      ...
      secondary: 'bg-white/80 dark:bg-white/10 backdrop-blur-md border border-gray-200 dark:border-white/20 text-gray-900 dark:text-white hover:bg-gray-100 dark:hover:bg-white/20',
      outline:
