...
import { Instagram, Linkedin, Github, Mail, Search, Users, Award, Sparkles, ExternalLink } from 'lucide-react';
...
function TeamMemberCard({ member, index }: { member: TeamMember; index: number }) {
  ...
  const getImageUrl = () => {
    ...
    return `https://fra.cloud.appwrite.io/v1/storage/buckets/team/files/${member.photoId}/view?project=691e2b31003e6415bb4f`;
  };
    ...
    >
      <Card hover className="group overflow-hidden">
        ...
        <CardHeader>
          ...
          {member.bio && (
            <p className="text-sm text-gray-400 mt-2 line-clamp-2">{member.bio}</p>
          )}
        </CardHeader>
      </Card>
    </motion.div>
